...
df_zhang_CASPT2 = CSV.read("examples/validate_zhang/ethene/Zhang2011Ethene.dat", DataFrame;
              delim=' ',
              ignorerepeated=true,
              comment="#",
              header=false)
...
df_orca_steom_ccsd = CSV.read("examples/validate_zhang/ethene/ethene_steom_ccsd_singlet_triplet.csv", DataFrame; delim=',')
...
steom_ccsd_triplet = df_orca_steom_ccsd[:,2]
steom_ccsd_singlet = df_orca_steom_ccsd[:,3]
...
@gp :- rs steom_ccsd_singlet "w lp title 'STEOM-CCSD Singlet'"
...
@gp :- rs steom_ccsd_triplet "w lp title 'STEOM-CCSD Triplet'"
Gnuplot.save("../../chem/zhang_plots/orca_steom-ccsd_zhang_caspt2_comparison_ethene_excited_states.pdf", term="pdfcairo enhanced size 8in,3in")
@gp :- "unset multiplot"
