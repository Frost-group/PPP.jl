...
@testset "Validate Bedogni2024Model with 2T-7N c.f. Bedogni2024 published values" begin
    system, huckel_result, scf_result = run_ppp_calculation("../molecules/2T-7N.xyz", Bedogni2024Model())
